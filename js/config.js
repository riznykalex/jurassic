...
export const BALANCE = {
  ...
  REST_THRESHOLD: 0.40,        // якщо під час руху energy впала нижче 50% - зупинитись відпочити
  ...
  GROUP_COUNTER_DAMAGE: 0.5,  // шкоди нападнику за кожного союзника поруч
  ...
  LETHAL_BITE_MULTIPLIER: 2,   // множник шкоди для укусу впритул (замість гарантованого one-hit
  ...
  TRIBE_RADIUS: 70,            // якщо люди в межах цього радіусу - вони в одному ланцюжку/племені
  ...
  IDLE_CHANCE: 0.3,            // шанс "зупинитись і постояти" замість руху при виборі дії
  IDLE_MIN_MS: 1500,
  IDLE_MAX_MS: 4500,
